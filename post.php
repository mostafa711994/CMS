    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            if(isset($_GET['p_id'])){
                ...
                //for check of drafted posts from the users
            ...
            if(isset($_POST['create_comment'])){
                ...
                //$count_result = mysqli_query($connection,$query);
                     ...
                     echo "<script>alert('This Field Can Be Empty')</script>";
                 }
            ...
            $posted_comment = mysqli_query($connection,$query);
            if(!$posted_comment){
                die("query failed" . mysqli_error($connection));
            }
            while($row = mysqli_fetch_assoc($posted_comment)){
